...
Ahri 这个实验性的项目我已经停止维护了。

**科学上网**需求，继续阅读下文。

**我已经独立完成了另一个专门用于科学上网的工具，我称呼ta为 SpreadX**。
要我评价 SpreadX，我只会告诉你挺不错的。我用了很久，还开发了 macOS 的 GUI 客户端，但是这个客户端我不会提供给大家。
我国（中国🇨🇳）国民素质逐步提高，我愿意相信能看到本文的人都是有较高素质的国民，不会做破坏国家安全的事情。

**所以，我已将 SpreadX （的执行文件及用法）直接 release 到 Ahri 的 release 页面**。
...
时间（2022-07-05 13:26:00）

---

有各类**内网穿透**需求的人，看这里[frp](https://github.com/fatedier/frp)。
